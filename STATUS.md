...
| L3 open | Live-model workload, semantic memory, true OTel spans, prompt caching, true preemption, non-replay resume, evaluation harness | planned | `docs/backlog.md` (`BL-120`, `BL-131`, `BL-113`/`138`, `BL-132`/`171`, `BL-155`, `BL-114`, `BL-130`) |
...
| `docs/adr/0001`-`0010` | stable (Accepted) |
